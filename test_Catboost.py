...
######
train_data = pd.read_csv('20231004_data.csv')
#X = train_data.drop(['ddg','pdb','ref','pos','chain','alt'], axis=1)
X = pd.read_csv("20231004_data.csv",usecols=['imf_2_dASA_meanValue', 'ASA_node_2', 'donor-num', 'dssp_b_shannon', 'd_ASA_c_24_32_hz', 'dssp_b_threshold', 'u_ASA_node_7', 'u_ASA_node_4', 'd_ASA_b_sure', 'u_ASA_Ed', 'dssp_node_4'])
...
for i in range(1):
    ...
    test_data = pd.read_csv('20231004_test_data.csv')
    y_test = test_data['ddg']
    #X_test = test_data.drop(['ddg','pdb','ref','pos','chain','alt'], axis=1)
    X_test = pd.read_csv("20231004_test_data.csv", usecols=['imf_2_dASA_meanValue', 'ASA_node_2', 'donor-num', 'dssp_b_shannon', 'd_ASA_c_24_32_hz', 'dssp_b_threshold', 'u_ASA_node_7', 'u_ASA_node_4', 'd_ASA_b_sure', 'u_ASA_Ed', 'dssp_node_4'])
